...
% Inputs: 
%
% g     - array          - function evaluated at the points of interest
% a     - \R             - lower limit of integration
% b     - \R             - upper limit of integration
% nodes - {2,\ldots,11\} - number of nodes in Newton-Cotes formula
%
% Outputs:
% Q         - \R     - result of numerical integration
%
% by Ram Vasudevan, 2013
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
