...
\begin{proof}
	...
	The desired result follows from a symmetry argument and a rearrangement. \todo{hoj:  Is the symmetry argument follow from an identity like $\abs{ m_{\lambda , \mu} } = \abs{m_{\mu,\lambda} }$.  It's not obvious to me at the moment. }
\end{proof}
