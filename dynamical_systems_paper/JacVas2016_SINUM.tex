...
We will see that conservation laws provide complete characterizations for the above PDEs in \S \ref{sec:operator theory}
...
For a smooth compact $n$-manifold, $M$, let $\Dens(M)$ denote the space of smooth densities, which we view as a subspace of the anti-symmetric multilinear functions on $\bigoplus^n TM$.
