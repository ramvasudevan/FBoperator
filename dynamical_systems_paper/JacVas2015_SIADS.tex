...
\todo[inline]{Spell it like ``Liouville''}
...
This insight is true, but not nearly as significant or fundamental as the the declaration ``We can encode all english words using the numbers $0$ and $1$.''
...
It is a result known to algebraic geometers, at least implicitly, that this insight characterizes \eqref{eq:function pde} completely without any extra baggage.
...
In this section we will briefly illustrate why this is true, guided by insights from the theory of $C*$-algebras.
