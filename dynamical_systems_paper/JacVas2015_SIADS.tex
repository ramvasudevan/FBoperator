...
\end{align}
and $H^s(M ,g)$ is then the function space obtained by completion with respect to this norm.  Such a definition is equivalent to the one provided in \cite{Hebey1999}.
In particular, note that $H^0(M;g) = L^2(M;\mu_g)$.
...
This will be useful later, in section \ref{sec:discretization}, when we discretize.
