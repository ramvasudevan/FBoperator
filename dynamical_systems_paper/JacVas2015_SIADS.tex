...
In particular, if we consider the streched Gaussian
\begin{align}
...
we can consider the resulting wrapped distribution $\tilde{p}$ on $\mathbb{T}$ as an initial condition which we shall evolve by the dynamics.
...
Finally, the bottom row depicts the results from using a direct Fourier based discretization of \eqref{eq:density}.
