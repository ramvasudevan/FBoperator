...
Most notably, the method of \cite{Calvo1997} is specialized to isospectral flows such as  \eqref{eq:function pde} and \eqref{eq:density pde} and preserves the invariants of isospectral flows over large time-step sizes.
