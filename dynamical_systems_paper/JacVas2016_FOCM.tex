...
%In this ``functions come first'' perspective, $C^1(X)$ is the subspace for which the derivations are bounded, and points are algebra preserving maps in the dual space (these coincide with the Dirac-delta functionals).
...
This should not be too shocking, as spectral schemes take functions as the computational building block, in contrast to grid/particle based methods which take points as the central objects.
